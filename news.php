    ...
    <nav class="navbar navbar-expand-lg slide-down">
        <div class="container position-relative">
            ...
            <div class="d-flex justify-content-between align-items-center w-100 d-lg-none">
                <a class="navbar-brand text-white text-sm-start" href="#">News</a>
            ...
            */
            ...
            if ($result && $result->num_rows > 0) {
                ...
                foreach ($news_data as $news) {
                    ...
                    $formatted_date = date('d F Y', strtotime($news['date']));
            ?>
                                    ...
                                    <div class="image-grid" style="max-height: 400px;">
                                        <?php foreach ($news['images'] as $image): ?>
                                            <img src="<?php echo htmlspecialchars($image['path']); ?>"
                                                alt="<?php echo htmlspecialchars($image['caption'] ?: 'News Image'); ?>"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-widget">
                        ...
                        <div class="contact-info">
                            ...
                            <p><i class="fas fa-clock"></i> Mon - Fri: 8:30 AM - 4:30 PM</p>
                        </div>
                    </div>
                </div>
            </div>
