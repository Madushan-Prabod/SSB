...
<head>
    ...
    <style>
        ...
        .footer {
            ...
            color: var(--text-color);
            padding: 0;
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif, 'noto sans tamil', 'noto serif sinhala';
        }
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <span class="contact-item d-none d-md-inline-block"><i class="fas fa-clock"></i>திங்கள் – வெள்ளி:
                        காலை 8:30 – மாலை 4:15</span>
                </div>
    ...
    <div class="theme">
        ...
        <div class="theme-content">
            <h1 class="theme-title">செய்தி</h1>
        </div>
    </div><br>
    <!-- Content -->
    <div class="container">
            ...
            */
            ...
            if ($result && $result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if (!isset($news_data[$id])) {
                        ...
                        $formatted_date = $day . ' ' . $tamil_months[$month] . ' ' . $year;

                        // Tamil fallback
                        $title = !empty($row['title_tam']) 
                            ? $row['title_tam'] 
                            : $row['title_en'];

                        $content = !empty($row['content_tam']) 
                            ? $row['content_tam'] 
                            : $row['content_en'];
            ...
            <?php
                ...
                echo '<div class="modern-box" style="padding:40px; text-align:center; color:#666;">
                        ...
                        <p>தற்போது வெளியிடப்பட்ட செய்திகள் எதுவும் இல்லை.</p>
                    </div>';
            }
    ...
    <footer class="footer">
        ...
        <script id="messenger-widget-b" src="https://cdn.botpenguin.com/website-bot.js"
            defer>68ef1a6c163de854554fecda, 68ef19b7cb64f686dfb5b548</script>
        <!-- accessibility -->
