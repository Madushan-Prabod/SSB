...
<head>
  ...
  <style>
    ...
    body {
      font-family: 'Poppins', sans-serif, 'Noto Serif Sinhala', 'Abhaya Libre', 'Gemunu Libre', 'Noto Sans Tamil';
      margin: 0;
      padding: 0;
    ...
    .footer {
      ...
      color: var(--text-color);
      padding: 0;
      font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif, 'Noto Serif Sinhala', 'Abhaya Libre', 'Gemunu Libre', 'Noto Sans Tamil';
    }
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          ...
          <span class="contact-item d-none d-md-inline-block"><i class="fas fa-clock"></i>සඳුදා - සිකුරාදා: පෙ.ව. 8:30 -
            ප.ව. 4:15</span>
        </div>
  ...
  <nav class="navbar navbar-expand-lg slide-down">
    <div class="container position-relative">
      ...
      <div class="d-flex justify-content-between align-items-center w-100 d-lg-none">
        <a class="navbar-brand text-white text-sm-start" href="#">මාධ්‍ය ගැලරිය</a>
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown d-lg-block">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="gov_leaders_sin.html">රජයේ නායකයින්</a></li>
  ...
  <div class="theme">
    ...
    <div class="theme-content">
      <h1 class="theme-title">මාධ්‍ය ගැලරිය</h1>
    </div>
  </div>

  <div class="box">
    <div class="filter-nav">
      <button class="filter-btn active" data-filter="all">සියලුම</button>
      <button class="filter-btn" data-filter="events">සිදුවීම්</button>
      <button class="filter-btn" data-filter="meetings">රැස්වීම්</button>
      <button class="filter-btn" data-filter="awards">සම්මාන</button>
      <button class="filter-btn" data-filter="projects">ව්යාපෘති</button>
    </div>
  </div>
  <?php
  ...
  <section class="gallery-section" id="events-section">
    <div class="section-title">
      <h2><b>විශේෂ සිදුවීම්</b></h2>
      <p>ප්‍රජා සහ නිල ආරක්ෂක සිදුවීම්</p>
    </div>
    ...
    <div class="gallery-container">
      <div class="gallery-row">
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">සිදුවීම් හමු නොවීය.</p>';
        }
        ?>
      </div>
      <div class="scroll-indicator">තවත් → බැලීමට තිරස් අතට අනුචලනය කරන්න</div>
    </div>
  </section>
  ...
  <section class="gallery-section" id="meetings-section">
    <div class="section-title">
      <h2><b>රැස්වීම්</b></h2>
      <p>උපායමාර්ගික සහ නිල රැස්වීම්</p>
    </div>
    <div class="gallery-container">
      <div class="gallery-row">
        <?php
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">රැස්වීම් හමු නොවීය.</p>';
        }
        ?>
      </div>
      <div class="scroll-indicator">තවත් → බැලීමට තිරස් අතට අනුචලනය කරන්න</div>
    ...
    <div class="gallery-container">
      <div class="gallery-row">
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">සම්මාන හමු නොවීය.</p>';
        }
        ?>
      </div>
      <div class="scroll-indicator">තවත් → බැලීමට තිරස් අතට අනුචලනය කරන්න</div>
  ...
  <section class="gallery-section" id="projects-section">
    <div class="section-title">
      <h2><b>ව්‍යාපෘති</b></h2>
      <p>දැනට පවතින සහ සම්පූර්ණ කරන ලද මුලපිරීම්</p>
    </div>
    ...
    <div class="gallery-container">
      <div class="gallery-row">
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">ව්‍යාපෘති හමු නොවීය.</p>';
        }
        ?>
      </div>
      <div class="scroll-indicator">තවත් → බැලීමට තිරස් අතට අනුචලනය කරන්න</div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-widget">
            <img src="./assets/images/logo.jpg" alt="Sri Lanka Social Security Board Logo" class="footer-logo"
              style="width: 80px; height:200px;">
            <p class="text mb-4" style="text-align: justify;">ශ්‍රී ලංකා සමාජ ආරක්ෂණ මණ්ඩලය සියළු පුරවැසියන්ට ස්ථායී සහ
              නවෝත්පාදන සමාජ ආරක්ෂණ වැඩසටහන් මඟින්
              සමාජ ආරක්ෂාව සහ සුභසාධනය සහතික කිරීමේ අරමුණින් කටයුතු කරයි.</p>
            <div class="social-links">
              <a href="https://web.facebook.com/ssb.gov.lk?mibextid=ZbWKwL&_rdc=1&_rdr#" target="_blank"><i
                  class="fab fa-facebook-f"></i></a>
              <a href="mailto:info@ssb.gov.lk" target="_blank"><i class="fas fa-envelope"></i></a>
              <a href="https://www.youtube.com/@slsosebo" target="_blank"><i class="fab fa-youtube"></i></a>
          ...
          <div class="col-lg-3 col-md-6 footer-widget">
            ...
            <div class="newsletter-form"><abbr title="Clean Sri Lanka">
                <a href="https://cleansrilanka.gov.lk/" target="_blank" rel="noopener noreferrer">
                  <img src="./assets/images/Clean Sri Lanka Logo.png" alt="NewsLetter Image" class="img-thumbnail"
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-4">
            <div class="made-with">
              Made with <i class="fas fa-heart"></i> by Department of Information Technology, Faculty of Humanities &
