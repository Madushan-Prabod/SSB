...
<head>
    ...
    <title>News - Social Security Board</title>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Abhaya+Libre:wght@400;500;600;700;800&family=Gemunu+Libre:wght@200..800&family=Noto+Serif+Sinhala:wght@100..900&display=swap"
        rel="stylesheet">
    <style>
        :root {
            --navy-blue: #0a192f;
        ...
        body {
            font-family: 'Poppins', sans-serif, 'noto serif sinhala';
            margin: 0;
            padding: 0;
        ...
        .footer {
            ...
            color: var(--text-color);
            padding: 0;
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif, 'noto serif sinhala';
        }
        ...
        .info-box::after {
            ...
            width: 100%;
            height: 4px;
            background: linear-gradient(to right, transparent, #0a5257, transparent);
        ...
        .contact-container {
            ...
            animation: alternate-reverse 1.2s ease-out forwards;
            box-shadow: 0 10px 30px rgba(13, 2, 156, 0.281);
        }
        ...
        .mission-box::before {
            background: linear-gradient(90deg, #48bb78 0%, #0a192f 100%);
        }
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <span class="contact-item d-none d-md-inline-block"><i class="fas fa-clock"></i>සඳුදා - සිකුරාදා:
                        පෙ.ව. 8:30 - ප.ව. 4:15</span>
                </div>
    ...
    <nav class="navbar navbar-expand-lg slide-down">
        <div class="container position-relative">
            ...
            <div class="d-flex justify-content-between align-items-center w-100 d-lg-none">
                <a class="navbar-brand text-white text-sm-start" href="#">පුවත්</a>
            ...
            <div class="desktop-nav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index_sin.html">මුල් පිටුව</a>
                    </li>
                    ...
                    <li class="nav-item dropdown d-lg-block">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="vision_mission_sin.html">දැක්ම සහ මෙහෙවර</a></li>
                            <li><a class="dropdown-item" href="gov_leaders_sin.html">රාජ්‍ය නිලධාරීන්</a></li>
                            <li><a class="dropdown-item" href="board_of_directors_sin.html">අධ්‍යක්ෂක මණ්ඩලය</a></li>
                            <li><a class="dropdown-item" href="management_team_sin.html">මණ්ඩලයේ කළමනාකාරීත්වය</a></li>
                            <li><a class="dropdown-item" href="social_security_div_sin.html">සමාජ ආරක්ෂණ අංශය</a></li>
                            <li><a class="dropdown-item" href="admin_div_sin.html">පරිපාලන අංශය</a></li>
                            <li><a class="dropdown-item" href="finance_div_sin.html">මුදල් අංශය</a></li>
                            <li><a class="dropdown-item" href="internal_audit_sin.html">අභ්‍යන්තර විගණන අංශය</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="services_sin.html">ප්‍රගතිය</a></li>
                            <li><a class="dropdown-item" href="scheme_sin.html">විශ්‍රාම වැටුප් යෝජනා ක්‍රම</a></li>
                        </ul>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="application_sin.html">භාගත කිරීම්</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="gallery_sin.php">මාධ්‍ය ගැලරිය</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="right_to_informarion_sin.html">තොරතුරු දැනගැනීමේ අයිතිය</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="news_sin.php">පුවත්</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="contact_sin.html">අමතන්න</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="careers_sin.html">රැකියා පුරප්පාඩු</a>
                    </li>
                </ul>
                ...
                <div class="utility-section d-lg-none">
                    <div class="dropdown lang-selector">
                        <a class="btn btn-secondary" href="news_sin.php">සිංහල</a>
                        <a class="btn btn-secondary" href="news.php">English</a>
                        <a class="btn btn-secondary" href="news_tam.php">தமிழ்</a>
                    </div>
                </div>
            </div>
            ...
            <div class="dropdown lang-selector d-none d-lg-block">
                <button class="btn dropdown-toggle" type="button" id="desktopLangDropdown" data-bs-toggle="dropdown">
                    <i class="fas fa-globe me-1"></i> සිංහල
                </button>
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="./news.php">English</a></li>
                    <li><a class="dropdown-item" href="./news_sin.php">සිංහල</a></li>
                    <li><a class="dropdown-item" href="./news_tam.php">தமிழ்</a></li>
                </ul>
            </div>
    ...
    <div class="theme">
        ...
        <div class="theme-content">
            <h1 class="theme-title">පුවත්</h1>
        </div>
    </div><br>
    <!-- Content -->
<div class="container">
    <div class="containerr" style="flex-direction:column; gap:24px; padding:24px 12px;">
        <?php
        include 'db_connect.php';

        /*
        ✅ SINGLE OPTIMIZED QUERY
        Fetch news + images together
        NO get_result()
        */
        $sql = "
        SELECT 
            ...
            ni.caption_sin
        FROM news n
        LEFT JOIN news_images ni 
            ON n.id = ni.news_id
        WHERE n.status='published'
        ORDER BY n.date DESC, n.created_at DESC, ni.display_order ASC
        ";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if (!isset($news_data[$id])) {
                    ...
                    $formatted_date = $day . ' ' . $sinhala_months[$month] . ' ' . $year;

                    // Sinhala fallback
                    $title = !empty($row['title_sin']) ? $row['title_sin'] : $row['title_en'];
                    $content = !empty($row['content_sin']) ? $row['content_sin'] : $row['content_en'];
                ...
                if (!empty($row['image_path'])) {
                    ...
                    $caption = !empty($row['caption_sin'])
                        ? $row['caption_sin']
                        : ($row['caption_en'] ?: 'News Image');
        ...
        ?>
                ...
                <!-- News Item -->
                <div class="modern-box" style="padding:20px; margin-bottom:30px;">
                    <div style="display:flex; gap:20px; flex-wrap:wrap;">
                        <div style="flex:1; min-width:300px;">

                            <div class="row">
                                <div class="col-10">
                                    <div style="color:#ffffff; font-weight:bold; font-size:1.4rem; background-color: #0a192f;">
                                        &nbsp;
                                ...
                                <div class="col-2">
                                    <div style="color:#001530; margin:10px 0; background-color: #ffffff;">
                                        <?php echo $news['date']; ?>
                                    </div>
                                </div>
                            </div>

                            <p style="line-height:1.6; color:#444; text-align: justify;">
                                <?php echo nl2br(htmlspecialchars($news['content'])); ?>
                            </p>

                            <?php if (!empty($news['images'])): ?>
                                <div class="image-grid" style="max-height: 400px;">
        ...
        <?php
            ...
            echo '<div class="modern-box" style="padding:40px; text-align:center; color:#666;">
                    <i class="fas fa-newspaper" style="font-size:3rem; margin-bottom:20px; color:#ccc;"></i>
                    <h3>පුවත් නොමැත</h3>
                    <p>දැනට ප්‍රකාශිත පුවත් ලිපි නොමැත.</p>
                  </div>';
        }
        ...
        <!-- Zoom Modal -->
        <div id="imageModal" class="image-modal" onclick="closeZoom()">
            <img id="zoomedImage">
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-widget">
                        ...
                        <p class="text mb-4" style="text-align: justify;">ශ්‍රී ලංකා සමාජ ආරක්ෂණ මණ්ඩලය සියළු
                            පුරවැසියන්ට ස්ථායී සහ නවෝත්පාදන සමාජ ආරක්ෂණ වැඩසටහන් මඟින්
                            සමාජ ආරක්ෂාව සහ සුභසාධනය සහතික කිරීමේ අරමුණින් කටයුතු කරයි.</p>
                    ...
                    <div class="col-lg-3 col-md-6 footer-widget">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="scheme.html">අපගේ සේවාවන්</a></li>
                            <li><a href="surekuma.html">සුරැකුම යෝජනා ක්‍රමය</a></li>
                            <li><a href="arassawa.html">ආරස්සාව යෝජනා ක්‍රමය</a></li>
                            <li><a href="kalakaru.html">කලාකරු යෝජනා ක්‍රමය</a></li>
                            <li><a href="vigamanika.html">විගමනික යෝජනා ක්‍රමය</a></li>
                            <li><a href="nawikaya.html">නාවිකයා යෝජනා ක්‍රමය</a></li>
                            <li><a href="news.php">පුවත් සහ සිදුවීම්</a></li>
                        </ul>
                    </div>

                    <!-- Useful Links Widget -->
                    <div class="col-lg-3 col-md-6 footer-widget">
                        <h5>ප්‍රයෝජනවත් සබැඳි</h5>
                        <ul class="footer-links">
                            <li><a href="right_to_informarion.html">තොරතුරු ලබාගැනීමේ අයිතිය</a></li>
                            <li><a href="careers.html">රැකියා පුරප්පාඩු</a></li>
                            <!-- <li><a href="about.html">FAQ</a></li> -->
                            <!-- <li><a href="#">Privacy Policy</a></li> -->
                            <li><a href="scheme.html">සේවා නියමයන්</a></li>
                            <li><a href="contact.html">වෙබ් අඩවි සිතියම</a></li>
                            <li><a href="https://stateminsamurdhi.gov.lk/" target="_blank">අමාත්‍යංශ වෙබ් අඩවිය</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 footer-widget">
                        ...
                        <div class="contact-info">
                            <p><i class="fas fa-map-marker-alt"></i> අංක 18, “සමාජ ආරක්ෂණ පියස” <br>
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;රාජගිරිය පාර, <br>
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;රාජගිරිය.</p>
                            <p><i class="fas fa-phone-alt"></i> +94 112 886 585 - 86</p>
                            <p><i class="fas fa-envelope"></i> info@ssb.gov.lk</p>
                            <p><i class="fas fa-clock"></i> සඳුදා - සිකුරාදා: පෙ.ව. 8:30 - ප.ව. 4:15</p>
                        </div>
                        <div class="newsletter-form"><abbr title="Clean Sri Lanka">
                                <a href="https://cleansrilanka.gov.lk/" target="_blank" rel="noopener noreferrer">
                                    <img src="./assets/images/Clean Sri Lanka Logo.png" alt="NewsLetter Image"
                                        class="img-thumbnail"
                                        style="width: 200px; height: auto; margin-top: 10px;"></a></abbr>
                        </div>
                    </div>
                </div>
            </div>
