...
<body>
  ...
  <nav class="navbar navbar-expand-lg slide-down">
    <div class="container position-relative">
      ...
      <div class="d-flex justify-content-between align-items-center w-100 d-lg-none">
        <a class="navbar-brand text-white text-sm-start" href="#">Gallery</a>
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown d-lg-block">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="gov_leaders.html">Government Leaders</a></li>
              ...
              <li><a class="dropdown-item" href="social_security_div.html">Social Security Division</a></li>
  ...
  <div class="theme">
    ...
    <div class="theme-content">
      <h1 class="theme-title">GALLERY</h1>
    </div>
  </div>
  ...
  <section class="gallery-section" id="events-section">
    <div class="section-title">
      <h2><b>SPECIAL EVENTS</b></h2>
      <p>Community and Official Security Events</p>
    </div>
    ...
    <div class="gallery-container">
      <div class="gallery-row">
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">No events found.</p>';
        }
        ?>
      </div>
  ...
  <section class="gallery-section" id="meetings-section">
    <div class="section-title">
      <h2><b>MEETINGS</b></h2>
      <p>Strategic and Official Gatherings</p>
    </div>
    <div class="gallery-container">
      <div class="gallery-row">
        <?php
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">No meetings found.</p>';
        }
        ?>
      </div>
      <div class="scroll-indicator">Scroll horizontally to see more →</div>
  ...
  <section class="gallery-section" id="awards-section">
    <div class="section-title">
      <h2><b>AWARDS</b></h2>
      <p>Recognition and Celebrations</p>
    </div>
    ...
    <div class="gallery-container">
      <div class="gallery-row">
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">No awards found.</p>';
        }
        ?>
      </div>
      <div class="scroll-indicator">Scroll horizontally to see more →</div>
  ...
  <section class="gallery-section" id="projects-section">
    <div class="section-title">
      <h2><b>PROJECTS</b></h2>
      <p>Ongoing and completed initiatives</p>
    </div>
    <div class="gallery-container">
      <div class="gallery-row">
        <?php
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p class="text-center text-muted w-100">No projects found.</p>';
        }
        ?>
      </div>
      <div class="scroll-indicator">Scroll horizontally to see more →</div>
    ...
    <div class="gallery-container">
      <div class="gallery-row">
        <div class="gallery-item">
          ...
          <div class="gallery-item-bg bg-6">
            Placeholder for project image
          </div>
          <div class="gallery-item-overlay">
            <h3>Equipment Donation</h3>
            <p>Supporting local institutions</p>
          </div>
        </div>

        <div class="gallery-item">
          <span class="category-label">Project</span>
          <div class="gallery-item-bg bg-5">
            Placeholder for project image
          </div>
          <div class="gallery-item-overlay">
            <h3>Training Facilities Upgrade</h3>
        ...
        <div class="gallery-item">
          <span class="category-label">Project</span>
          <div class="gallery-item-bg bg-4">
            Placeholder for project image
          </div>
          <div class="gallery-item-overlay">
            <h3>Digital Security Initiative</h3>
            <p>Implementation of new systems</p>
          </div>
        </div>

        <div class="gallery-item wide">
          <span class="category-label">Project</span>
          <div class="gallery-item-bg bg-3">
            Placeholder for main project image
          </div>
          <div class="gallery-item-overlay">
            <h3>Community Security Program</h3>
            <p>Village-level security enhancements</p>
          </div>
        </div>

        <div class="gallery-item">
          <span class="category-label">Project</span>
          <div class="gallery-item-bg bg-2">
            Placeholder for project image
          </div>
          <div class="gallery-item-overlay">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-widget">
            ...
            <p class="text mb-4" style="text-align: justify;">The Sri Lanka Social Security Board is dedicated to
              ensuring social protection and welfare for all citizens through sustainable and innovative social security
              programs.</p>
            ...
            <div class="newsletter-form">
              <a href="https://cleansrilanka.gov.lk/" target="_blank" rel="noopener noreferrer">
                <img src="./assets/images/Clean Sri Lanka Logo.png" alt="NewsLetter Image" class="img-thumbnail"
                  style="width: 200px; height: auto; margin-top: 10px;"></a>
            </div>
          </div>
        </div>
      </div>
